...
namespace TAC_AI.AI.Enemy
{
    public static class RMiner
    {
        public static void MineYerOwnBusiness(AIECore.TankAIHelper thisInst, Tank tank, RCore.EnemyMind mind)
        {
            ...
            {
                thisInst.foundBase = AIECore.FetchClosestHarvestReceiver(tank.rootBlockTrans.position, tank.Radar.Range + 150, out thisInst.lastBasePos, out thisInst.theBase, tank.Team);
