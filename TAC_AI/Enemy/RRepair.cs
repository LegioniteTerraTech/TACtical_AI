    ...
    public static class RRepair
    {
        ...
        public static bool EnemyInstaRepair(Tank tank, EnemyMind mind, int RepairAttempts = 0)
        {
            ...
            try
            {
                if (mind.TechMemor.SystemsCheck() && PreRepairPrep(tank, mind))
                {
                    ...
                    {
                        bool worked = EnemyRepairLerp(tank, mind, ref fBlocks, ref typesMissing);
                        if (!worked)
                            break;
        ...
        public static bool EnemyRepairStepper(AIECore.TankAIHelper thisInst, Tank tank, EnemyMind mind, bool Super = false)
        {
            ...
            */
            ...
            {
                DebugTAC_AI.Log("TACtical_AI: Enemy AI " + tank.name + ":  Tried to call EnemyRepairStepper when TechMemor is NULL");
                return false;
            }
